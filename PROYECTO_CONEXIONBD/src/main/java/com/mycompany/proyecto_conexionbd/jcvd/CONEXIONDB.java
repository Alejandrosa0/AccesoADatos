...
public class CONEXIONDB {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("\nnuevoRegistro (Por teclado):"); //F1 23, Carreras, 2023-04-28, Codemasters, 60
            nuevoRegistro();
            //Elimina un registro
            System.out.println("\neliminarRegistro:");
    ...
    public static void nuevoRegistro(String nombre, String genero, Date fechaLanzamiento, String compañia, float precio) {
    ...
    public static void nuevoRegistro() {
        ...
        System.out.println("Nuevo registro de videojuego:");
