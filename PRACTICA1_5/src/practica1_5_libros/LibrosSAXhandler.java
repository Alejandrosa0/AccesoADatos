...
public class LibrosSAXhandler extends DefaultHandler {
    ...
    @Override
    //Método invocado al encontrar un elemento de inicio en el documento XML
    ...
    @Override
    //Método invocado al encontrar datos de caracteres en el documento XML
    public void characters(char[] ch, int start, int length) throws SAXException {
        ...
        if (car.trim().length() > 0) { //Verifica si la cadena no está vacía
            System.out.print(car + "//"); //Agrega "//" entre el título y el autor
        }
    }
}
