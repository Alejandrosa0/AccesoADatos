...
public class UsaAccesoDOM {
    ...
    public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
        ...
        a.insertarLibroEnDOM("Yerma", "Lorca", "1935"); //Llamamos a los métodos para insertar un libro en el archivo XML y eliminar un libro (nodo) del archivo XML
        a.deleteNode("Don Quijote"); 
        
        a.guardarDOMcomoArchivo("LibrosDeDOM.xml"); //Guardará el documento modificado en un archivo llamado ("LibrosDeDOM.xml")
    }
}
